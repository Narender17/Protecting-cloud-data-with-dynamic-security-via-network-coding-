            ...
            <div class="container px-lg-5">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        String dna=BinaryToDNA.convert(binary);
                    
                        %>
                        <div class="position-relative w-100 my-3 wow fadeInUp" data-wow-delay="0.3s">
                        <center>
                            <form action="SendDNAAction.jsp" method="post">
                            <table>
                            ...
                            <tr><th>Ascii</th><td><input type="text" name="ascii" value="<%=ascii%>" required=""></td></tr>
                             <tr><th>Hexadecimal</th><td><input type="text" name="hexadecimal" value="<%=hexadecimal%>" required=""></td></tr>
                              <tr><th>Binary Data</th><td><textarea cols="30" rows="5" name="binary"><%=binary%></textarea></td></tr>
                             <tr><th>DNA</th><td><textarea cols="30" rows="5" name="dna"><%=dna%></textarea></td></tr>
                        <tr><th></th><td><input type="submit" value="Implement DNA"></td></tr>
                            </table>
                            </form>
                        </center>
